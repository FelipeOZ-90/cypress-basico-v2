...
describe('Central de Atendimento ao Cliente TAT', function() {
  ...
  it('preenche e limpa os campos nome, sobrenome, email e telefone', function() {
    ...
    cy.get('#lastName').type('Zacarias').should('have.value', 'Zacarias').clear().should('have.value', '')
    cy.get('#email').type('felipe@teste.com').should('have.value', 'felipe@teste.com').clear().should('have.value', '')
